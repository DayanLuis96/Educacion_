<%@ Page Title="" Language="C#" MasterPageFile="~/Educacion/Aplicacion/Principal/MasterPage.Master" AutoEventWireup="true" CodeBehind="Inicial.aspx.cs" Inherits="Educacion.Educacion.Aplicacion.Pagina.Inicial" %>
    ...
    <div class="main-content-body">
        ...
        <div class="col-md-12 col-lg-12 col-xl-12">
            ...
            <div class="row">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex month">
                                            <h5 class="float-left font-weight-normal text-muted tx-13">
                                                <p>¡Bienvenido a Educacion, solicita tus servicios aquí:</p>
                                            </h5>
                ...
                <asp:Panel ID="panelAdministrador" runat="server" Visible="false" CssClass="col-md-12 col-lg-6 col-xl-6">
                ...
                <asp:Panel ID="panel1" runat="server" Visible="false" CssClass="col-md-12 col-lg-6 col-xl-6">
