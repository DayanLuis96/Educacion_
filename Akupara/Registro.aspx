<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registro.aspx.cs" Inherits="Educacion.Registro" %>
                    ...
                    <div class="block grid-cols-2 gap-4 xl:grid">
                        <div class="flex-col hidden min-h-screen xl:flex">
                            <a href="" class="flex items-center pt-5 -intro-x text-center">
                                <img alt="Midone Tailwind HTML Admin Template" class="w-32 text-center" src="Educacion/assets/img/escudoUnal.png"></a>
                            <div class="my-auto">
