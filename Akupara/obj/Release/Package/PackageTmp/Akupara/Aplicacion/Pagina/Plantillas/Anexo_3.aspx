<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Anexo_3.aspx.cs" Inherits="Akupara.Akupara.Aplicacion.Pagina.Plantillas.Anexo_3" %>
                        ...
                        <div class="card-header pb-0">
                            <div class="pd-15  bg-gray-200 small formlayout">
                                <div class="col-12 col-sm-12 col-lg-12 col-xl-12" >
                                    <b>Análisis de Fragmentos - Productos PCR</b>
                                                ...
                                                <div class="row row-sm">
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:TextBox runat="server" ID="txtNombrePlato" aria-describedby="basic-addon1" aria-label="Username" class="form-control form-control-sm" type="text" />
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:TextBox runat="server" ID="txtPozo" aria-describedby="basic-addon1" aria-label="Username" class="form-control form-control-sm" type="text" />
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:TextBox runat="server" ID="txtconc" aria-describedby="basic-addon1" aria-label="Username" class="form-control form-control-sm" type="text" />
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:TextBox runat="server" ID="txtVolumen" aria-describedby="basic-addon1" aria-label="Username" class="form-control form-control-sm" type="text" />
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="<i class='fa fa-info-circle'></i> Campo obligatorio"
                                                                ControlToValidate="txtVolumen" Display="Dynamic" ForeColor="Red"
                                                                ValidationGroup="CrearArticulo"></asp:RequiredFieldValidator>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:DropDownList runat="server" ID="ddl_marcajeFlu" class="form-control select2 form-control-sm" />
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="<i class='fa fa-info-circle'></i> Campo obligatorio"
                                                                ControlToValidate="ddl_marcajeFlu" InitialValue="0" Display="Dynamic" ForeColor="Red"
                                                                ValidationGroup="CrearArticulo"></asp:RequiredFieldValidator>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            <div class="input-group-prepend"><span class=" font-weight-bold mg-b-0" id="basic-addon2">Marcador de Peso *</span> </div>
                                                            <asp:DropDownList runat="server" ID="ddl_peso" class="form-control select2 form-control-sm" />
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" InitialValue="0" runat="server" ErrorMessage="<i class='fa fa-info-circle'></i> Campo obligatorio"
                                                                ControlToValidate="ddl_peso" Display="Dynamic" ForeColor="Red"
                                                                ValidationGroup="CrearArticulo"></asp:RequiredFieldValidator>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            <div class="input-group-prepend"><span class="font-weight-bold mg-b-0" id="basic-addon1">Tamaño producto PCR (pb) * </span></div>
                                                            <asp:TextBox runat="server" ID="txtTamnoProducto" aria-describedby="basic-addon1" aria-label="Username" class="form-control form-control-sm" type="text" />
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="<i class='fa fa-info-circle'></i> Campo obligatorio"
                                                                ControlToValidate="txtTamnoProducto" Display="Dynamic" ForeColor="Red"
                                                                ValidationGroup="CrearArticulo"></asp:RequiredFieldValidator>
                                                        </div>
                                                    </div>
                                                </div>
                 ...
                 <div class="pd-15  bg-gray-200 small formlayout">
                    <div class="card card-warning">
                        <div class="card-body text-warning">
                            Análisis de Fragmentos - Productos PCR
                              <div class="col-md-12 text-center">
                                ...
                                <table id="tableS" class="table table-sm table-striped  text-md-nowrap border">
                                    <thead style="background-color: #565A5D;">
                                        <tr class="text-center">
                                            <th style="background-color: #808B96; color: white;" colspan="10">Análisis de Fragmentos - Productos PCR</th>
                                        </tr>
                                        <tr>
