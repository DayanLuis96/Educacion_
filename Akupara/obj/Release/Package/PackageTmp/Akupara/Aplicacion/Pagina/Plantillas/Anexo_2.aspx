<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Anexo_2.aspx.cs" Inherits="Akupara.Akupara.Aplicacion.Pagina.Plantillas.Anexo_2" %>
                            ...
                            <div class="card card-secondary">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList runat="server" ID="txtrango" aria-describedby="basic-addon1" aria-label="Username" class="form-control select2 form-control-sm " type="text" ></asp:DropDownList>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <div class="input-group-prepend"><span class="font-weight-bold mg-b-0" id="basic-addon1">Secuencia (5´-3´)</span> </div>
                                        <asp:TextBox runat="server" ID="txtsecuencia5_3" aria-describedby="basic-addon1" aria-label="Username" class="form-control form-control-sm " type="text" />
