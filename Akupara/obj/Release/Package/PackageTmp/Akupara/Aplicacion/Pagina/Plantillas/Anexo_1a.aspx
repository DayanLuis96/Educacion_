<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Anexo_1a.aspx.cs" Inherits="Akupara.Akupara.Aplicacion.Pagina.Plantillas.Anexo_1a" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="card-header">
            <div class="row pb-0">
                ...
                <div class="col-12 col-sm-12 col-lg-12 col-xl-12" id="cargManual" runat="server" >
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                             <asp:Button runat="server" ID="btnvista1" OnClick="btnvista1_Click" CssClass="nav-link bg-primary active" Text="Anexo 1a" />
                        </li>
                        <li class="nav-item">
                            <asp:Button runat="server" ID="BtnVista2" OnClick="BtnVista2_Click" CssClass="nav-link bg-secundary" Text="Loci" />
                        </li>
                       
                    </ul>
                    <hr class="bg-success m-1" />
                    <div runat="server" visible="false" id="visAnexo1a">
                    ...
                    <div runat="server" visible="false" id="VisLoci">
                         <div class="pd-15  bg-gray-200 small formlayout">
                        <h6 class="card-title mb-0 pb-0">
                            <div class="row row-sm">
                                <div class="col-lg-3">
                                      <div class="form-group">
                                        <div class="input-group-prepend"><span class=" font-weight-bold mg-b-0" id="basic-addon2">Especie *</span> </div>
                                        <asp:TextBox runat="server" ID="txtEspecieLoci" class="form-control form-control-sm"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="<i class='fa fa-info-circle'></i> Campo obligatorio"
                                            ControlToValidate="txtEspecieLoci" Display="Dynamic" ForeColor="Red"
                                            ValidationGroup="AggLoci"></asp:RequiredFieldValidator>
                                    </div>
                                    </div>
                                 <div class="col-lg-3">
                                      <div class="form-group">
                                        <div class="input-group-prepend"><span class=" font-weight-bold mg-b-0" id="basic-addon2">Locus *</span> </div>
                                        <asp:TextBox runat="server" ID="txtLocus" class="form-control form-control-sm"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="<i class='fa fa-info-circle'></i> Campo obligatorio"
                                            ControlToValidate="txtLocus" Display="Dynamic" ForeColor="Red"
                                            ValidationGroup="AggLoci"></asp:RequiredFieldValidator>
                                    </div>
                                    </div>
                                <div class="col-lg-3">
                                      <div class="form-group">
                                        <div class="input-group-prepend"><span class=" font-weight-bold mg-b-0" id="basic-addon2">Nombre Primer/Cebador *</span> </div>
                                        <asp:TextBox runat="server" ID="txtNombrePrimer" class="form-control form-control-sm"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="<i class='fa fa-info-circle'></i> Campo obligatorio"
                                            ControlToValidate="txtNombrePrimer" Display="Dynamic" ForeColor="Red"
                                            ValidationGroup="AggLoci"></asp:RequiredFieldValidator>
                                    </div>
                                    </div>
                                 <div class="col-lg-3">
                                      <div class="form-group">
                                        <div class="input-group-prepend"><span class=" font-weight-bold mg-b-0" id="basic-addon2">Secuencia Forward (5´-3´) *</span> </div>
                                        <asp:TextBox runat="server" ID="txtsecuForwardLoci" class="form-control form-control-sm"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="<i class='fa fa-info-circle'></i> Campo obligatorio"
                                            ControlToValidate="txtsecuForwardLoci" Display="Dynamic" ForeColor="Red"
                                            ValidationGroup="AggLoci"></asp:RequiredFieldValidator>
                                    </div>
                                    </div>
                                <div class="col-lg-3">
                                      <div class="form-group">
                                        <div class="input-group-prepend"><span class=" font-weight-bold mg-b-0" id="basic-addon2">Secuencia Reverse (5´-3´) *</span> </div>
                                        <asp:TextBox runat="server" ID="txtSecReverseLoci" class="form-control form-control-sm"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="<i class='fa fa-info-circle'></i> Campo obligatorio"
                                            ControlToValidate="txtSecReverseLoci" Display="Dynamic" ForeColor="Red"
                                            ValidationGroup="AggLoci"></asp:RequiredFieldValidator>
                                    </div>
                                    </div>
                                 <div class="col-lg-3">
                                      <div class="form-group">
                                        <div class="input-group-prepend"><span class=" font-weight-bold mg-b-0" id="basic-addon2">Motivo de repetición *</span> </div>
                                        <asp:TextBox runat="server" ID="txtMtvRepLoci" class="form-control form-control-sm"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="<i class='fa fa-info-circle'></i> Campo obligatorio"
                                            ControlToValidate="txtMtvRepLoci" Display="Dynamic" ForeColor="Red"
                                            ValidationGroup="AggLoci"></asp:RequiredFieldValidator>
                                    </div>
                                    </div>
                                  <div class="col-lg-3">
                                      <div class="form-group">
                                        <div class="input-group-prepend"><span class=" font-weight-bold mg-b-0" id="basic-addon2">Rango alélico *</span> </div>
                                        <asp:TextBox runat="server" ID="txtRangoAlelicoLoci" class="form-control form-control-sm"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ErrorMessage="<i class='fa fa-info-circle'></i> Campo obligatorio"
                                            ControlToValidate="txtRangoAlelicoLoci" Display="Dynamic" ForeColor="Red"
                                            ValidationGroup="AggLoci"></asp:RequiredFieldValidator>
                                    </div>
                                    </div>
                                 <div class="col-lg-3">
                                      <div class="form-group">
                                        <div class="input-group-prepend"><span class=" font-weight-bold mg-b-0" id="basic-addon2">Marcaje Fluorescente *</span> </div>
                                        <asp:DropDownList runat="server" ID="txtMarcaFluorecente" class="form-control select2 form-control-sm"></asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ErrorMessage="<i class='fa fa-info-circle'></i> Campo obligatorio"
                                            ControlToValidate="txtMarcaFluorecente" Display="Dynamic" ForeColor="Red"
                                            ValidationGroup="AggLoci"></asp:RequiredFieldValidator>
                                    </div>
                                    </div>
                                <div class="col-lg-6">
                                      <div class="form-group">
                                        <div class="input-group-prepend"><span class=" font-weight-bold mg-b-0" id="basic-addon2">Observaciones *</span> </div>
                                        <asp:TextBox runat="server" ID="txtObservacionesLoci" class="form-control form-control-sm"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ErrorMessage="<i class='fa fa-info-circle'></i> Campo obligatorio"
                                            ControlToValidate="txtObservacionesLoci" Display="Dynamic" ForeColor="Red"
                                            ValidationGroup="AggLoci"></asp:RequiredFieldValidator>
                                    </div>
                                    </div>
                                </div>
                ...
                <div runat="server" id="panelAgregar" visible="false">
                    <div class="pd-15  bg-gray-200 small formlayout">
                        <div class="card card-warning">
                            ...
                            <div class="card-body text-warning">
                              ...
                              <div class="col-md-12 text-center ">
                                  <asp:LinkButton runat="server" ID="btnAgregar" Visible="false" OnClick="btnAgregar_Click" ValidationGroup="CrearArticulo" class="btn btn-primary btn-rounded "> <i class="fa fa-arrow-down"></i> Agregar
                                  </asp:LinkButton>
                                            ...
                                            <asp:Repeater runat="server" ID="tbLoci">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <asp:LinkButton runat="server" ID="btnEditarLoci" data-toggle="tooltip" title="Editar" OnCommand="btnEditarLoci_Command" CommandArgument='<%#Eval("ID")%>'><i class="fa fa-pencil text-info fa-2x"></i></asp:LinkButton>
                                                            <asp:LinkButton runat="server" ID="lbn_EliminarLoci" data-toggle="tooltip" title="Eliminar" OnCommand="lbn_EliminarLoci_Command" CommandArgument='<%#Eval("ID")%>'><i class="fa  fa-trash text-danger fa-2x"></i></asp:LinkButton>
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
