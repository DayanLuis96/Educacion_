<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CargueFinalResultadosCrudos.ascx.cs" Inherits="Akupara.Akupara.Aplicacion.Pagina.Muestras.Backup.CargueFinalResultadosCrudos" %>

<div class="col-lg-12">
    <div class="form-group">
        <div class="input-group-prepend"><span class="font-weight-bold mg-b-0" id="basic-addon1">Tipo resultado: </span></div>
        <asp:DropDownList runat="server" ID="ddl_TipoResultadoFIN" class="form-control select2 form-control-sm "></asp:DropDownList>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="<i class='fa fa-info-circle'></i> Campo obligatorio"
            ControlToValidate="ddl_TipoResultadoFIN" InitialValue="0" Display="Dynamic" ForeColor="Red"
            ValidationGroup="AdjuntosFileResulFIN"></asp:RequiredFieldValidator>
    </div>
</div>
        ...
        <div class="col-xs-12 col-sm-12" style="margin-bottom: 1%">
            ...
            <div class="form-group " style="text-align: center;">
                ...
                <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="<span class='badge rounded-pill bg-primary text-white ms-auto'><i class='fa fa-info-circle fa-2x'></i> Debe seleccionar al menos un archivo</span>"
                    ...
                    ValidationGroup="AdjuntosFileResulFIN"></asp:CustomValidator>
...
<asp:LinkButton runat="server" ID="BtnGuardarmuestras" OnClientClick="showProgressBar();" ValidationGroup="AdjuntosFileResulFIN" class="btn btn-secondary btn-rounded btn-block">Cargar</asp:LinkButton>
