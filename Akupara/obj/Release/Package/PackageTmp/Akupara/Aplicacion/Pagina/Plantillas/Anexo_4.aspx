<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Anexo_4.aspx.cs" Inherits="Akupara.Akupara.Aplicacion.Pagina.Plantillas.Anexo_4" %>
        ...
        <div class="card-header">
            <div class="row pb-0">
                ...
                <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="<i class='fa fa-info-circle'></i> Campo obligatorio"
                                                ControlToValidate="txtorganismo" InitialValue="0" Display="Dynamic" ForeColor="Red"
                                                ValidationGroup="CrearArticulo"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="<i class='fa fa-info-circle'></i> Campo obligatorio"
                                                ControlToValidate="txttipomuestra" InitialValue="0" Display="Dynamic" ForeColor="Red"
                                                ValidationGroup="CrearArticulo"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="<i class='fa fa-info-circle'></i> Campo obligatorio"
                                                ControlToValidate="txtestado" InitialValue="0" Display="Dynamic" ForeColor="Red"
                                                ValidationGroup="CrearArticulo"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                    ...
                    <div class="col-12 col-sm-12 col-lg-12 col-xl-12" id="Div1" runat="server" visible="true">
                                ...
                                <div class="card-header pb-0">
                                    <div class="pd-15  bg-gray-200 small formlayout">
                                        <div class="col-12 col-sm-12 col-lg-12 col-xl-12">
                                            <b>Ácidos Nucleicos - Información reacción</b>
                                                ...
                                                <div class="card-header pb-0">
                                                    <h6 class="card-title mb-0 pb-0">
                                                        <div class="row row-sm">
                                                            <div class="col-lg-3">
                                                                <div class="form-group">
                                                                    <div class="input-group-prepend"><span class=" font-weight-bold mg-b-0" id="basic-addon2">Método extracción *</span> </div>
                                                                    <asp:DropDownList runat="server" ID="ddl_metodoextracion" class="form-control select2 form-control-sm" />
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="<i class='fa fa-info-circle'></i> Campo obligatorio"
                                                                        ControlToValidate="ddl_metodoextracion" InitialValue="0" Display="Dynamic" ForeColor="Red"
                                                                        ValidationGroup="CrearArticulo"></asp:RequiredFieldValidator>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-3">
                                                                <div class="form-group">
                                                                    <div class="input-group-prepend"><span class=" font-weight-bold mg-b-0" id="basic-addon2">Purificación *</span> </div>
                                                                    <asp:DropDownList runat="server" ID="ddl_purificacion" class="form-control select2 form-control-sm" />
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" InitialValue="0" runat="server" ErrorMessage="<i class='fa fa-info-circle'></i> Campo obligatorio"
                                                                        ControlToValidate="ddl_purificacion" Display="Dynamic" ForeColor="Red"
                                                                        ValidationGroup="CrearArticulo"></asp:RequiredFieldValidator>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="form-group">
                                                                    <div class="input-group-prepend"><span class="font-weight-bold mg-b-0" id="basic-addon1">Tamaño producto (pb)  </span></div>
                                                                    <asp:TextBox runat="server" ID="txtTamahnoProduc" aria-describedby="basic-addon1" aria-label="Username" class="form-control form-control-sm" type="text" />
                                                                ...
                                                                ControlToValidate="txtTamahnoProduc" Display="Dynamic" ForeColor="Red"
                                                                ValidationGroup="CrearArticulo"></asp:RequiredFieldValidator>--%>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="form-group">
                                                                    <div class="input-group-prepend"><span class="font-weight-bold mg-b-0" id="basic-addon1">T°C alineamiento </span></div>
                                                                    <asp:TextBox runat="server" ID="txtAlineamiento" aria-describedby="basic-addon1" aria-label="Username" class="form-control form-control-sm" type="text" />
                                                                ...
                                                                ControlToValidate="txtAlineamiento" Display="Dynamic" ForeColor="Red"
                                                                ValidationGroup="CrearArticulo"></asp:RequiredFieldValidator>--%>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-12 col-sm-12 col-lg-12 col-xl-12">
                                            <b>Información Primers/Cebadores</b>
                                            <div class="card card-secondary">
                                                <div class="card-header pb-0">
                                                        ...
                                                        <div class="row row-sm">
                                                            <div class="col-lg-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <asp:TextBox runat="server" ID="txtNombre" aria-describedby="basic-addon1" aria-label="Username" class="form-control form-control-sm" type="text" />
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="form-group">
                                                                    <div class="input-group-prepend"><span class="font-weight-bold mg-b-0" id="basic-addon1">Secuencia Forward </span></div>
                                                                    <asp:TextBox runat="server" ID="txtSecuencia" aria-describedby="basic-addon1" aria-label="Username" class="form-control form-control-sm" type="text" />
                                                                ...
                                                                ControlToValidate="txtSecuencia" Display="Dynamic" ForeColor="Red"
                                                                ValidationGroup="CrearArticulo"></asp:RequiredFieldValidator>--%>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="form-group">
                                                                    <div class="input-group-prepend"><span class="font-weight-bold mg-b-0" id="basic-addon1">Secuencia Reverse  </span></div>
                                                                    <asp:TextBox runat="server" ID="txtSecuenciaRever" aria-describedby="basic-addon1" aria-label="Username" class="form-control form-control-sm" type="text" />
                                                                ...
                                                                ControlToValidate="txtSecuenciaRever" Display="Dynamic" ForeColor="Red"
                                                                ValidationGroup="CrearArticulo"></asp:RequiredFieldValidator>--%>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <asp:TextBox runat="server" ID="txtConcentracion" aria-describedby="basic-addon1" aria-label="Username" class="form-control form-control-sm" type="text" />
                                                                ...
                                                                ControlToValidate="txtConcentracion" Display="Dynamic" ForeColor="Red"
                                                                ValidationGroup="CrearArticulo"></asp:RequiredFieldValidator>--%>
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <div class="pd-15  bg-gray-200 small formlayout">
                            <div class="card card-warning">
                                ...
                                <div class="card-body text-warning">
                                    Extracción y Purificación de Ácidos Nucleicos - PCR 
                                        ...
                                        <table id="tableS" class="table table-sm table-striped  text-md-nowrap border">
                                            <thead style="background-color: #565A5D;">
                                                <tr class="text-center">
                                                    <th style="background-color: #1C2833; color: white;" colspan="4">Información muestra</th>
