<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Educacion.Login" %>
                    ...
                    <div class="block grid-cols-2 gap-4 xl:grid">
                        <div class="flex-col hidden min-h-screen xl:flex">
                            <a href="" class="flex items-center pt-5 -intro-x text-center">
                                <img alt="Midone Tailwind HTML Admin Template" class="w-32 text-center" src="Educacion/assets/img/Logosie.png"></a>
                            <div class="my-auto">
                                ...
                                <div class="mt-5 text-lg text-white -intro-x text-opacity-70 dark:text-slate-400">Sistema Integral de Gestión Educativa </div>
                            </div>
                        </div>
                            ...
                            <div class="w-full px-5 py-8 mx-auto my-auto bg-white rounded-md shadow-md xl:ml-20 dark:bg-darkmode-600 xl:bg-transparent sm:px-8 xl:p-0 xl:shadow-none sm:w-3/4 lg:w-2/4 xl:w-auto">
                                <div class=" row-start-4">
                                    <div class="col-span-12  w-52  rounded-full">
                                        <asp:Image runat="server" src="assets/Logo.png" />
                                    </div>
                                </div>
                                <div class="mt-2 text-center intro-x text-slate-400 xl:hidden">Accede al Sistema Sistema Integral de Gestión Educativa </div>
